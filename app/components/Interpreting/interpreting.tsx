...
function Interpreting(){const InterList: InterProps[] = [
    {
        Cover: "/interpreting/picture.jpg",
        Title: "Lorem ipsum dolor sit amet",
        Description: "consectetur adipiscing elit, sed do eiusmod temporincididunt ut labore et dolore magna aliqua. Ut enim ad mini."
    },
    {
        Cover: "/interpreting/picture.jpg",
        Title: "Lorem ipsum dolor sit amet",
